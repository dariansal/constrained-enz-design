#!/usr/bin/env bash
#SBATCH --job-name=rfdiff_1ca2_shell5
#SBATCH --output=/hpc/group/naderilab/darian/Enz/slurm/logs/rfdiff_1ca2_shell5_%j.out
#SBATCH --error=/hpc/group/naderilab/darian/Enz/slurm/logs/rfdiff_1ca2_shell5_%j.err
...
# Output: PDB files in results/rfdiffusion/1ca2_shell5/
# =============================================================================
