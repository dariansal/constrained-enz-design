#!/usr/bin/env bash
#SBATCH --job-name=rfdiff_1ppf_shell8
#SBATCH --output=/hpc/group/naderilab/darian/Enz/slurm/logs/rfdiff_1ppf_shell8_%j.out
#SBATCH --error=/hpc/group/naderilab/darian/Enz/slurm/logs/rfdiff_1ppf_shell8_%j.err
...
# Output: PDB files in results/rfdiffusion/1ppf_shell8/
# =============================================================================
