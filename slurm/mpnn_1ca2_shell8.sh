#!/usr/bin/env bash
#SBATCH --job-name=mpnn_1ca2_shell8
#SBATCH --output=/hpc/group/naderilab/darian/Enz/slurm/logs/mpnn_1ca2_shell8_%j.out
#SBATCH --error=/hpc/group/naderilab/darian/Enz/slurm/logs/mpnn_1ca2_shell8_%j.err
...
# Output FASTA files go to results/proteinmpnn/1ca2_shell8/
# =============================================================================
