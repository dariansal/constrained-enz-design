#!/usr/bin/env bash
#SBATCH --job-name=rfdiff_1ppf_shell5
#SBATCH --output=/hpc/group/naderilab/darian/Enz/slurm/logs/rfdiff_1ppf_shell5_%j.out
#SBATCH --error=/hpc/group/naderilab/darian/Enz/slurm/logs/rfdiff_1ppf_shell5_%j.err
...
# Output: PDB files in results/rfdiffusion/1ppf_shell5/
# =============================================================================
...
REGIME="shell5"         # motif_only | shell5 | shell8
N_DESIGNS=20
# ----------------------------------------------------------
