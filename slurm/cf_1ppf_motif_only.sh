#!/usr/bin/env bash
#SBATCH --job-name=cf_1ppf_motif_only
#SBATCH --output=/hpc/group/naderilab/darian/Enz/slurm/logs/cf_1ppf_motif_only_%j.out
#SBATCH --error=/hpc/group/naderilab/darian/Enz/slurm/logs/cf_1ppf_motif_only_%j.err
...
#   results/colabfold/1ppf_motif_only/
# =============================================================================
