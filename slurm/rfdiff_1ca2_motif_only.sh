#!/usr/bin/env bash
#SBATCH --job-name=rfdiff_1ca2_motif_only
#SBATCH --output=/hpc/group/naderilab/darian/Enz/slurm/logs/rfdiff_1ca2_motif_only_%j.out
#SBATCH --error=/hpc/group/naderilab/darian/Enz/slurm/logs/rfdiff_1ca2_motif_only_%j.err
...
# Output: PDB files in results/rfdiffusion/1ca2_motif_only/
# =============================================================================
