#!/usr/bin/env bash
#SBATCH --job-name=rfdiff_1ppf_motif_only
#SBATCH --output=/hpc/group/naderilab/darian/Enz/slurm/logs/rfdiff_1ppf_motif_only_%j.out
#SBATCH --error=/hpc/group/naderilab/darian/Enz/slurm/logs/rfdiff_1ppf_motif_only_%j.err
...
# Output: PDB files in results/rfdiffusion/1ppf_motif_only/
# =============================================================================

set -euo pipefail

# ---------- Parameters (filled by submit_all.sh) ----------
ENZ="1ppf"               # enzyme id: 1ppf or 1ca2
REGIME="motif_only"         # motif_only | shell5 | shell8
N_DESIGNS=20
# ----------------------------------------------------------
