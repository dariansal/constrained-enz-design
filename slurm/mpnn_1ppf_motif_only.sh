#!/usr/bin/env bash
#SBATCH --job-name=mpnn_1ppf_motif_only
#SBATCH --output=/hpc/group/naderilab/darian/Enz/slurm/logs/mpnn_1ppf_motif_only_%j.out
#SBATCH --error=/hpc/group/naderilab/darian/Enz/slurm/logs/mpnn_1ppf_motif_only_%j.err
...
# Output FASTA files go to results/proteinmpnn/1ppf_motif_only/
# =============================================================================
