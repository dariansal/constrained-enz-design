#!/usr/bin/env bash
#SBATCH --job-name=cf_1ppf_shell5
#SBATCH --output=/hpc/group/naderilab/darian/Enz/slurm/logs/cf_1ppf_shell5_%j.out
#SBATCH --error=/hpc/group/naderilab/darian/Enz/slurm/logs/cf_1ppf_shell5_%j.err
