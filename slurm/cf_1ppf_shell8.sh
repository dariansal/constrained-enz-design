#!/usr/bin/env bash
#SBATCH --job-name=cf_1ppf_shell8
#SBATCH --output=/hpc/group/naderilab/darian/Enz/slurm/logs/cf_1ppf_shell8_%j.out
#SBATCH --error=/hpc/group/naderilab/darian/Enz/slurm/logs/cf_1ppf_shell8_%j.err
