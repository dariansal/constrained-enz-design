#!/usr/bin/env bash
#SBATCH --job-name=mpnn_1ppf_shell8
#SBATCH --output=/hpc/group/naderilab/darian/Enz/slurm/logs/mpnn_1ppf_shell8_%j.out
#SBATCH --error=/hpc/group/naderilab/darian/Enz/slurm/logs/mpnn_1ppf_shell8_%j.err
...
# Output FASTA files go to results/proteinmpnn/1ppf_shell8/
# =============================================================================
