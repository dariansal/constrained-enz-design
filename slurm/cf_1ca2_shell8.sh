#!/usr/bin/env bash
#SBATCH --job-name=cf_1ca2_shell8
#SBATCH --output=/hpc/group/naderilab/darian/Enz/slurm/logs/cf_1ca2_shell8_%j.out
#SBATCH --error=/hpc/group/naderilab/darian/Enz/slurm/logs/cf_1ca2_shell8_%j.err
