...
Both global and local pLDDT decrease monotonically with tighter conditioning for both enzymes. Local pLDDT drops substantially: for 1PPF from 61.3 (motif\_only) to 30.7 (shell8), and for 1CA2 from 56.2 to 34.0. This trend reflects the increasingly constrained sequence design problem — ProteinMPNN must simultaneously satisfy more geometric constraints, yielding lower-probability sequences that AlphaFold2 predicts with less confidence. Notably, motif\_only experiments yield the highest local pLDDT (61.3 and 56.2 for 1PPF and 1CA2, respectively), because those sequences have greater scaffold freedom and likely fold into environments more familiar to AlphaFold2. The high pLDDT for 1PPF motif\_only coincides with its lowest RMSD (4.6~\AA{}), making motif-only elastase designs the most locally confident and geometrically accurate — though still far from native geometry.
