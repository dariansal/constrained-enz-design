#!/usr/bin/env bash
#SBATCH --job-name=rfdiff_ENZ_REGIME
#SBATCH --output=/hpc/group/naderilab/darian/Enz/slurm/logs/rfdiff_ENZ_REGIME_%j.out
#SBATCH --error=/hpc/group/naderilab/darian/Enz/slurm/logs/rfdiff_ENZ_REGIME_%j.err
...
# Output: PDB files in results/rfdiffusion/ENZ_REGIME/
# =============================================================================

set -euo pipefail

# ---------- Parameters (filled by submit_all.sh) ----------
ENZ="ENZ"               # enzyme id: 1ppf or 1ca2
REGIME="REGIME"         # motif_only | shell5 | shell8
N_DESIGNS=20
# ----------------------------------------------------------
